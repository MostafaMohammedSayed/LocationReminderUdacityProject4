...
fun wholeAppTest() {
    ...
    Espresso.onView(ViewMatchers.withText("Reminder Saved !")).inRoot(RootMatchers.withDecorView(ViewMatchers.isCompletelyDisplayed())).check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
